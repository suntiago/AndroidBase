...
public class Api {
    ...
    private static String BAIJIHU_HOST = "10.161.120.225";
    private static String ZHUSHAN_HOST = "10.160.6.24";
    private static String DEFAULT_HOST = BAIJIHU_HOST;//"192.168.1.208";
