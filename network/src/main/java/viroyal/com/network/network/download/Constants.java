...
public class Constants {
    ...
    public static final String DEVICE_CONFIGURE = "device_configure";
    public static final String IS_PERMISSION_OPEN = "is_permission_open";
    public final static int IS_UPDATE_CANCELED = 1;
    public final static String IS_SERVICE_STARTED = "is_service_started";
}
